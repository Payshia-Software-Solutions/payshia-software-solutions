    ...
    <header className="absolute top-0 z-50 w-full bg-transparent text-white">
      <div className="container flex h-24 items-center">
        <Link href="/" className="mr-6 flex items-center space-x-2">
          <span className="text-2xl font-bold font-headline inline-block text-primary">Payshia <span className="text-white">Software</span></span>
        </Link>
              ...
              <div className="flex flex-col h-full">
                <div className="flex items-center justify-between p-4 border-b">
                    <Link href="/" className="flex items-center space-x-2" onClick={() => setIsMobileMenuOpen(false)}>
                        <span className="font-bold text-lg font-headline inline-block text-primary">Payshia <span className="text-foreground">Software</span></span>
                    </Link>
